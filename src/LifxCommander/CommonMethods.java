...
public class CommonMethods {
   ...
   public static long convertHexStringToLong(String s) {
      return Long.parseLong(s, 16);
   }
   
   public static String getHexValueAsString(byte[] byteArray) {
   ...
   public static String getDateAsString(BigInteger nanoseconds) {
